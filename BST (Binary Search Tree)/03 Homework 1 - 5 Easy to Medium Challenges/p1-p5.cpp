...
public:
	 ...
	 * 
	 *   For leetcode problem use: bool isValidBST(TreeNode* root, long long mn = LONG_LONG_MIN, long long mx = LONG_LONG_MAX)
	...
	int kth_smallest(int &k) 
	{
		...
		return -1234; //we have traversed all the nodes 
	}
